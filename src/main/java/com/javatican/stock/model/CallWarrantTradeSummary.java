...
/*
 *  http://www.tse.com.tw/exchangeReport/MI_INDEX?response=html&date=20180615&type=0999
 */
@Entity
@Table(name = "call_warrant_trade_summary", uniqueConstraints = {
		@UniqueConstraint(columnNames = { "trading_date", "stock_symbol" }) })
public class CallWarrantTradeSummary {
	@Id
	...
	public CallWarrantTradeSummary() {
		super();
	}

	public CallWarrantTradeSummary(Date tradingDate) {
		super();
		this.tradingDate = tradingDate;
	}

	public CallWarrantTradeSummary(Date tradingDate, String stockSymbol) {
		super();
		this.tradingDate = tradingDate;
