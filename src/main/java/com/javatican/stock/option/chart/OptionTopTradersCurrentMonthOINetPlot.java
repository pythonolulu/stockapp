...
@Component("ottcmoinPlot")
public class OptionTopTradersCurrentMonthOINetPlot extends OptionParentPlot {

	public OptionTopTradersCurrentMonthOINetPlot() {
	}
	...
	private TimeSeriesCollection createOIDataset() {
		...
		odList.stream().forEach(fd -> {
			series1.add(new Day(fd.getTradingDate()),
					fd.getCallBuyOiTop10() - fd.getCallSellOiTop10() - fd.getPutBuyOiTop10() + fd.getPutSellOiTop10());
			series2.add(new Day(fd.getTradingDate()),
					fd.getCallBuyOiTop5() - fd.getCallSellOiTop5() - fd.getPutBuyOiTop5() + fd.getPutSellOiTop5());
			series3.add(new Day(fd.getTradingDate()), fd.getCallBuyOiTop10() - fd.getCallBuyOiTop5()
					- fd.getCallSellOiTop10() + fd.getCallSellOiTop5()
					- (fd.getPutBuyOiTop10() - fd.getPutBuyOiTop5() - fd.getPutSellOiTop10() + fd.getPutSellOiTop5()));
		});
		// add data
