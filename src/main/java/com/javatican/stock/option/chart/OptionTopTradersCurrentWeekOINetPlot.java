...
@Component("ottcwoinPlot")
public class OptionTopTradersCurrentWeekOINetPlot extends OptionParentPlot {

	public OptionTopTradersCurrentWeekOINetPlot() {
	}
	...
	private TimeSeriesCollection createOIDataset() {
		...
		odList.stream().forEach(fd -> {
			if (fd.getCallBuyOiTop10Week() != null) {
				series1.add(new Day(fd.getTradingDate()), fd.getCallBuyOiTop10Week() - fd.getCallSellOiTop10Week()
						- fd.getPutBuyOiTop10Week() + fd.getPutSellOiTop10Week());
				series2.add(new Day(fd.getTradingDate()), fd.getCallBuyOiTop5Week() - fd.getCallSellOiTop5Week()
						- fd.getPutBuyOiTop5Week() + fd.getPutSellOiTop5Week());
				series3.add(new Day(fd.getTradingDate()),
						fd.getCallBuyOiTop10Week() - fd.getCallBuyOiTop5Week() - fd.getCallSellOiTop10Week()
								+ fd.getCallSellOiTop5Week() - (fd.getPutBuyOiTop10Week() - fd.getPutBuyOiTop5Week()
										- fd.getPutSellOiTop10Week() + fd.getPutSellOiTop5Week()));
			}
		});
		// add data
