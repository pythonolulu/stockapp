...
public class IndividualStockService {
	 ...
	 * The data downloaded include records for the whole month, some may have been downloaded before.
	...
	/*
	 * Download daily trading value/volume and prices within past six months for stockSymbol, only need to run once.
	 */
	public void prepareData(String stockSymbol) throws StockException {
		//List<String> dateList = Arrays.asList("20180101", "20180201", "20180301", "20180401", "20180501");
