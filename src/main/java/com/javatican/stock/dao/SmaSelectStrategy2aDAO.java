...
@Repository("smaSelectStrategy3DAO")
public class SmaSelectStrategy2aDAO {
	private final Logger logger = LoggerFactory.getLogger(this.getClass());
	private static ObjectMapper objectMapper = new ObjectMapper();
	private static DateFormat df = new SimpleDateFormat("yyyy/MM/dd");
	private static final String RAW_STATS_RESOURCE_FILE_PATH = "file:./strategy/2a_raw/%s.json";
	private static final String STATS_RESOURCE_FILE_PATH = "file:./strategy/2a/%s_%s.json";
	@Autowired
