...
public class ChartService {
	...
	public class StockChartUtil {
		...
		private JFreeChart createChart() {
			...
			kdRenderer.setSeriesShape(2, new Ellipse2D.Double(-2d, -2d, 4d, 4d));
			...
			if (!cwtsList.isEmpty()) {
				...
				cwatvRenderer.setSeriesPaint(0, Color.BLACK);
				cwatvRenderer.setSeriesLinesVisible(0, false);
				cwatvRenderer.setSeriesShapesVisible(0, true);
				cwatvRenderer.setSeriesShape(0, new Ellipse2D.Double(-2d, -2d, 4d, 4d));
				//
				...
				//
				icnvRenderer.setSeriesPaint(1, Color.BLUE);
				icnvRenderer.setSeriesLinesVisible(1, false);
				icnvRenderer.setSeriesShapesVisible(1, true);
				icnvRenderer.setSeriesShape(1, new Ellipse2D.Double(-2d, -2d, 4d, 4d));
				...
				dsnbRenderer.setSeriesPaint(0, Color.BLACK);
			...
			if (!pwtsList.isEmpty()) {
				...
				if (cwtvSubplot != null)
					pwtvRenderer.setSeriesVisibleInLegend(0, false);
				// Create call warrant trade value Subplot
				...
				pwatvRenderer.setSeriesPaint(0, Color.BLACK);
				pwatvRenderer.setSeriesLinesVisible(0, false);
				pwatvRenderer.setSeriesShapesVisible(0, true);
				pwatvRenderer.setSeriesShape(0, new Ellipse2D.Double(-2d, -2d, 4d, 4d));
				//
				pwtvSubplot.setRenderer(1, pwatvRenderer);

				if (cwtvSubplot != null)
					pwatvRenderer.setSeriesVisibleInLegend(0, false);
				pwtvSubplot.setRenderer(1, pwatvRenderer);
				// 3rd axis for call warrant transaction
				...
				if (cwtvSubplot != null)
					pwtRenderer.setSeriesVisibleInLegend(0, false);
				...
				//
				ipnvRenderer.setSeriesPaint(1, Color.BLUE);
				ipnvRenderer.setSeriesLinesVisible(1, false);
				ipnvRenderer.setSeriesShapesVisible(1, true);
				ipnvRenderer.setSeriesShape(1, new Ellipse2D.Double(-2d, -2d, 4d, 4d));
